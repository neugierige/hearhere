...
//
//  Created by Prima Prasertrat on 3/20/15.
        ...
        for layoutAttributes in answer {
            if let representedElementKind = layoutAttributes.representedElementKind {
                if representedElementKind == UICollectionElementKindSectionHeader {
                    ...
                    origin.x = min(max(contentOffset.x, (CGRectGetMinX(firstCellAttributes.frame) - headerHeight)), (CGRectGetMaxX(lastCellAttributes.frame) - headerHeight))
