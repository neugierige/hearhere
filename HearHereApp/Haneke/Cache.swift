...
public class Cache<T : DataConvertible where T.Result == T, T : DataRepresentable> {
    ...
    public func fetch(#key : String, @autoclosure value getValue :  () -> T.Result, formatName : String = HanekeGlobals.Cache.OriginalFormatName, success succeed : Fetch<T>.Succeeder? = nil) -> Fetch<T> {
